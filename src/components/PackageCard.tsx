...
const PackageCard: React.FC<PackageCardProps> = ({ pkg, selected, onSelect }) => {
  ...
  const iconSize = isMobile ? settings.packageIconSizeMobile || 50 : settings.packageIconSizeDesktop || 32;
  ...
  return (
    ...
    >
      ...
      {pkg.label && (
        ...
        >
          {pkg.labelIcon && <img src={pkg.labelIcon} alt="" className="w-4 h-4 object-contain" />}
          <span
      ...
      <div
        ...
        style={{
          ...
          border: settings.packageBorderWidth
            ? `${settings.packageBorderWidth}px solid ${settings.packageBorderColor || "#fc4400"}`
            : "none",
